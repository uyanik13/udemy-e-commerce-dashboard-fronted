<template>
  <h2 class="mt-10 text-lg font-medium intro-y">Product Category List</h2>
  <div class="grid grid-cols-12 gap-6 mt-5">
    <div
      class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap"
    >
      <button class="mr-2 shadow-md btn btn-primary">
        <router-link :to="{ name: 'product-category-create' }"
          >Create</router-link
        >
      </button>
      <Dropdown>
...
const edit = (id) => {
  router.push({ name: "product-category-edit", params: { id: id } });
};
