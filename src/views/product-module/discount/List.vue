<template>
  <h2 class="mt-10 text-lg font-medium intro-y">Discount List</h2>
  <div class="grid grid-cols-12 gap-6 mt-5">
    <div
      class="flex flex-wrap items-center col-span-12 mt-2 intro-y sm:flex-nowrap"
    >
      <button class="mr-2 shadow-md btn btn-primary">
        <router-link :to="{ name: 'discount-create' }">Create</router-link>
      </button>
      <Dropdown>
      ...
      <table class="table -mt-2 table-report">
        <thead>
          <tr>
            ...
            <th class="text-center whitespace-nowrap">DISCOUNT-PERCENT</th>
...
const edit = (id) => {
  router.push({ name: "discount-edit", params: { id: id } });
};
